...
export const problem = {
  ...
  items: [
    ...
    "Manual certification checks alone eat 25–50 hours a month. Cross-referencing SM2, BOSIET and BNSP by hand takes time your recruiters should spend closing placements.",
  ],
